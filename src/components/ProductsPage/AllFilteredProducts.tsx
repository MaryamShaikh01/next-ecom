...
const AllFilteredProducts = (props: any) => {
    ...
    return (
        <>
            {
                isGrid ? (
                    <div className='order-1 border-[var(--border)] rounded-[12px] grid grid-cols-[repeat(auto-fit,minmax(150px,1fr))] md:grid-cols-[repeat(auto-fit,minmax(200px,1fr))] mb-5 border-1 '>
                        {data.map((item) =>
                    ...
                    : (
                        <>
                            ...
                            <div className='order-1 border-[var(--border)] rounded-[12px] grid grid-cols-1 lg:grid-cols-2 min-[2600px]:grid-cols-3  border-1 mb-20'>
                                {data.map((item) =>
