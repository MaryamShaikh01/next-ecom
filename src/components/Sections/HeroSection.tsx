    ...
    return (
        <>
            <div className='px-[10px] m-auto sm:w-[80vw] grid grid-cols-[auto_1fr] lg:gap-x-8 pt-8'>
                ...
                <div className='border-1 border-[var(--border)] rounded-lg h-fit w-[230px] hidden lg:block first:rounded-tl-lg'>
                    <Link href="/products" className='flex items-center  gap-x-2 px-3 py-3 border-b rounded-tr-lg rounded-tl-lg  border-b-[var(--border)] hover:bg-gray-100'>
                        <p className='flex items-center gap-x-2'>
                           <Grid2X2 className='w-5 h-5' strokeWidth={1.5}/> All Categories</p>
                    </Link>
                    <Link href="/products" className='flex items-center  gap-x-2 px-3 py-3 border-b  border-b-[var(--border)] hover:bg-gray-100'>
                    ...
                    <Link href="/" className='flex items-center  gap-x-2 px-3 py-3 border-b  border-b-[var(--border)] hover:bg-gray-100'>
