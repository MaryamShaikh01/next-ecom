    ...
    <>
      ...
      <div>
        ...
        <div className="flex justify-between items-center px-[10px] m-auto sm:w-[80vw] gap-x-3 py-5  ">
            ...
            <Link href="/products" className='border-1 border-var(--border) rounded-full bg-white text-xs font-bold px-[12px] py-[8px] w-fit flex gap-2 items-center whitespace-nowrap'>View All <img src="/Icon.svg" alt="" /></Link>
