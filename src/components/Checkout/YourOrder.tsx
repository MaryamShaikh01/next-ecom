    ...
    return (
        <>
            <div className='border-1 border-[var(--border)] rounded-md p-5 h-fit bg-[rgba(0,_0,_0,_0.01)]'>
                ...
                <p className=' text-xs font-medium flex justify-between py-2 border-b-1 border-[var(--border)]'>Total <span className='font-bold'>$15.89</span></p>
                ...
                <button className='px-5 py-3 bg-[var(--primary)] text-white font-bold rounded-lg w-full mt-2 cursor-pointer'>Place Order</button>
            </div>
        </>
    )
}
