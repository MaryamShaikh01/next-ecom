...
<HorizontalFilters/>
            ...
            <details className="group border-t-1 border-b-1 border-[var(--border)] py-5">
              <summary
                className="block relative after:absolute after:z-[-1] after:content-[url('/dropdown.png')] after:top-[50%] after:transform after:translate-y-[-50%] after:ml-[25%]  after:transition-[0.2s] group-open:after:rotate-[-90deg] text-sm font-semibold  ">
