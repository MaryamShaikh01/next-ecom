...
import LoginBreadcrumb from '@/components/SignIn/LoginBreadcrumb'
    ...
    <>
      ...
      <div className='m-auto w-[90vw] sm:w-[500px] px-2.5 flex flex-col items-center py-10 pb-40'>
        ...
        <div className='w-full flex flex-col  gap-y-4'>
          ...
          <Link href="/account" className='bg-[var(--primary)] self-center  text-white w-full text-center font-semibold px-5 py-2 rounded-lg cursor-pointer'>Log In</Link>
